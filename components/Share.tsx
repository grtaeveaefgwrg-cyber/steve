...
const TikTokIcon: React.FC = () => (
  <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5">
    <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.28-1.1-.68-1.6-1.12-1.1-1.02-1.6-2.43-1.6-3.95v.23c0 1.59-.57 3.19-1.6 4.31-1.02 1.11-2.52 1.68-4.04 1.77V1.5c1.4-.09 2.77-.55 3.9-1.48z" fill="#00f2ea" style={{transform: 'translate(-2px, -2px)', mixBlendMode: 'screen'}}/>
    <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.28-1.1-.68-1.6-1.12-1.1-1.02-1.6-2.43-1.6-3.95v.23c0 1.59-.57 3.19-1.6 4.31-1.02 1.11-2.52 1.68-4.04 1.77V1.5c1.4-.09 2.77-.55 3.9-1.48z" fill="#ff0050" style={{transform: 'translate(2px, 2px)', mixBlendMode: 'screen'}}/>
    <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.28-1.1-.68-1.6-1.12-1.1-1.02-1.6-2.43-1.6-3.95v.23c0 1.59-.57 3.19-1.6 4.31-1.02 1.11-2.52 1.68-4.04 1.77V1.5c1.4-.09 2.77-.55 3.9-1.48z" fill="#fff"/>
  </svg>
);
